...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     *
     * @tags Auth
     * @name E49Cba58A6405534Cdd7218D7499904A
     * @summary Registration
     * @request POST:/api/auth/register
     */
    e49Cba58A6405534Cdd7218D7499904A: (data: AuthRegisterRequest, params: RequestParams = {}) =>
      this.request<UserResource, void>({
  ...
  oauth = {
     ...
     *
     * @tags Auth
     * @name D0C4298C73B4D913763Efd3Df2C917Eb
     * @summary Get tokens
     * @request POST:/oauth/token
     */
    d0C4298C73B4D913763Efd3Df2C917Eb: (
      data:
        | {
            /** @example "password" */
            grant_type?: string
